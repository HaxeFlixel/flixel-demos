...
class MenuState extends FlxState
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		if (_title2.x > _title1.x + _title1.width - 4)
		{
			...
			var flixelButton = new FlxButton(FlxG.width / 2 - 40, FlxG.height / 3 + 54, "haxeflixel.com", function() FlxG.openURL("http://haxeflixel.com"));
			flixelButton.color = 0xff729954;
			flixelButton.label.color = 0xffd8eba2;
			add(flixelButton);

			var dannyButton = new FlxButton(flixelButton.x, flixelButton.y + 22, "music: dannyB", function() FlxG.openURL("http://dbsoundworks.com"));
